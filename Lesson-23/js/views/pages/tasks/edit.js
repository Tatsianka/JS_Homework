...
class Edit extends Component {
                ...
                html = `
					...
					<div class="task-edit">
				        ...
				        <p>
							...
							<textarea rows="5"  maxlength="150" placeholder="Add task description" class="task-edit__description">${description === 'None' ? '' : description}</textarea>
						</p>
    ...
    editTask(editTaskTitle, editTaskDescription) {
        ...
        this.task.description = editTaskDescription.value.trim() ? editTaskDescription.value.trim() : 'None';
